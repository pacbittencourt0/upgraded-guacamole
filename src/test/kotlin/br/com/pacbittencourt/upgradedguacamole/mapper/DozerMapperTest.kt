...
class DozerMapperTest {
    ...
    fun parseEntityListToVOListTest() {
        val outputList = DozerMapper.parseObjectList(inputObject!!.mockEntityList(), PersonVO::class.java)
    ...
    fun parserVOListToEntityListTest() {
        ...
        val outputList = DozerMapper.parseObjectList(inputObject!!.mockVOList(), Person::class.java)
